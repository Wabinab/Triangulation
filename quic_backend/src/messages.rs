...
pub(crate) const CHECKLIST_NONE: &'static str = "backend.ChecklistNone";
pub(crate) const CYCLE_IDX_CANNOT_NULL: &'static str = "backend.CycleIdxNull";
pub(crate) const OOB_CYCLE_IDX: &'static str = "backend.OOBCycle";
pub(crate) const CYCLE_NAME_NULL: &'static str = "backend.CycleNameNull";
pub(crate) const CYCLE_AT_LEAST_ONE: &'static str = "backend.AtLeastOneCycle";
pub(crate) const VEC_BOOL_ONLY: &'static str = "backend.VecBoolOnly";
pub(crate) const CHECKLIST_LEN_2: &'static str = "backend.ChecklistLen2";
pub(crate) const CHECKLIST_STRVEC: &'static str = "backend.ChecklistStrVec";
